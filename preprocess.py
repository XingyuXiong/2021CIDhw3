#kdd99数据集预处理
#将kdd99符号型数据转化为数值型数据
#there are 43 data dimensions, 42th is the attack type 
#coding:utf-8
...
#定义kdd99数据预处理函数
def preHandel_data(source_file='20 Percent Training Set.csv',handled_file='20 Percent Training Set1'):
...
if __name__=='__main__':
    ...
    label_list=[]
    source_file='KDDTest+.csv'
    Handle_file1='KDDTest+ Set1'
    Handle_file2='KDDTest+ Set2'
    Handle_file3='KDDTest+ Set3'
    preHandel_data(source_file,Handle_file1)
    Handle_data(Handle_file1,Handle_file2)
    Find_Maxmin(Handle_file2,Handle_file3)